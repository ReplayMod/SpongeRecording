...
public class SpongeConnectionClosedEvent extends SpongeConnectionEvent implements ConnectionClosedEvent {

    public SpongeConnectionClosedEvent(SpongeConnection connection) {
        super(connection);
    }
